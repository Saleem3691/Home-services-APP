      ...
      <section className="relative bg-rich-slate text-white py-24 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          >
            <path
              fill="#FFF"
              d="M14 16H9v-2h5V9h2v5h5v2h-5v5h-2v-5zm-8 0H1v-2h5V9h2v5h5v2H8v5H6v-5zm30 0h-5v-2h5V9h2v5h5v2h-5v5h-2v-5zm-8 0h-5v-2h5V9h2v5h5v2h-5v5h-2v-5z"
            ></path>
          </svg>
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-light-slate max-w-2xl mx-auto">
            Have questions or need assistance? Our expert team is ready to help
            you with all your home service needs.
          </p>
          <div className="mt-8 flex justify-center space-x-4">
            <a
              href="#contact-form"
              className="bg-accent hover:bg-accent-dark text-white font-medium py-3 px-6 rounded-lg transition duration-300 shadow-md hover:shadow-lg flex items-center"
            >
              <svg
            ...
            <a
              href="tel:+923184876263"
              className="bg-white text-rich-slate hover:bg-gray-100 font-medium py-3 px-6 rounded-lg transition duration-300 shadow-md hover:shadow-lg flex items-center"
            >
              <svg
                className="w-5 h-5 mr-2"
                fill="none"
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      } rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent text-black transition-colors duration-200`}
                ...
                <div>
                  <button
                    ...
                    className={`w-full bg-accent hover:bg-accent-dark text-white font-medium py-3 px-6 rounded-lg transition duration-300 shadow-md hover:shadow-lg relative ${
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <Link
                      href="/locations"
                      className="inline-block mt-2 text-accent hover:text-accent-dark text-sm font-medium transition-colors duration-200"
                    >
                      View all locations →
                    </Link>
                  </div>
            ...
            <div className="bg-gradient-to-br from-accent to-accent-dark text-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-white/90 mb-4">
                Our emergency support team is always ready to help you with
                urgent issues.
              </p>
              <a
                href="tel:+18001234567"
                className="inline-flex items-center bg-white text-accent hover:bg-gray-100 font-medium py-2 px-4 rounded-lg transition duration-300 shadow-sm hover:shadow-md"
              >
                <svg
                  className="w-5 h-5 mr-2"
                  fill="none"
