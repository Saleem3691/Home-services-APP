...
import {
  FaUser, FaEnvelope, FaEdit, FaSave, FaTimes, FaCamera,
  FaSpinner, FaCalendarAlt, FaIdBadge, FaClipboardList
} from "react-icons/fa";
              ...
              <div className="relative z-10 text-center">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="text-xl md:text-2xl font-bold bg-white/20 border-2 border-white/50 rounded-lg px-4 py-2 mb-4 w-full max-w-md mx-auto text-center text-white backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-white/50"
                    required
                  />
                ) : (
                ...
                <div className="inline-flex items-center bg-white/20 rounded-full px-4 py-2 backdrop-blur-sm">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      onChange={handleChange}
                      className="bg-transparent border-b border-white/50 focus:outline-none text-white w-full max-w-xs"
                      required
                    />
                  ) : (
                  ...
                  {isEditing ? (
                    <>
                      ...
                      <button
                        ...
                        className="flex-1 sm:flex-none bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 flex items-center justify-center transition-colors"
                      >
                    ...
                    <>
                      <button
                        ...
                        className="flex-1 sm:flex-none bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 flex items-center justify-center transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 sm:flex-none bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 flex items-center justify-center transition-colors"
                      >
                        Sign Out
                      </button>
                    </>
