      ...
      <section className="bg-gradient-to-r from-rich-slate to-slate-800 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-light-slate max-w-3xl mx-auto">
            Choose from our comprehensive range of services, all delivered by
            verified professionals with guaranteed quality.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto">
              ...
              we&apos;ll help arrange the perfect service for your needs.
            </p>
